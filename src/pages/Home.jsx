          ...
          <div className="max-w-[1400px] mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 md:space-x-5">
              ...
              {session ? (
                <>
                  <button
                    ...
                    className="text-neutral-500 dark:text-neutral-400 hover:text-red-600 transition p-1.5 cursor-pointer"
                ...
                <button
                  ...
                  className="flex items-center gap-2 border border-neutral-300 dark:border-neutral-700 bg-neutral-100/80 dark:bg-neutral-900/80 hover:border-red-600 dark:hover:border-red-600 text-neutral-800 dark:text-neutral-200 hover:text-red-600 dark:hover:text-red-500 text-xs md:text-sm font-semibold py-2 px-4 rounded-full transition-all duration-200 cursor-pointer shadow-sm hover:shadow-red-600/10"
                >
              ...
              <button
                ...
                className="bg-[#ff0000] hover:bg-red-700 text-white text-xs md:text-sm font-bold py-2.5 px-6 rounded-full transition-all duration-200 shadow-md shadow-red-950/30 hover:scale-105 cursor-pointer"
              >
                Contact us
              </button>
            </div>
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 text-center -mt-6 md:-mt-10">
            ...
            <div className="mt-8 flex items-center justify-center">
              <button
                ...
                className="border border-red-600 text-white text-xs md:text-sm font-semibold tracking-[0.08em] uppercase px-8 py-4 rounded-lg hover:bg-red-600/20 transition font-['Montserrat',sans-serif] cursor-pointer"
              >
                Book Now
              </button>
            </div>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-8 md:bottom-20 z-20 flex flex-col items-center">
            ...
            <button
              ...
              className="relative w-7 h-11 rounded-full border-2 border-slate-300/90 hover:border-red-500 transition-colors duration-300 flex items-start justify-center pt-[5px] cursor-pointer"
                    ...
                    >
                      ...
                      <div className="relative h-52 overflow-hidden">
                        ...
                        <button
                          ...
                          className="absolute top-4 left-1/2 -translate-x-1/2 px-5 py-2 rounded-full border border-neutral-500/70 bg-black/60 backdrop-blur-sm text-white text-xs font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-all duration-300 hover:border-red-500 hover:text-red-400 cursor-pointer"
                        >
                          View Event Samples
                        </button>
                      </div>
