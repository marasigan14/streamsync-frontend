    ...
    <div className={isDarkMode ? "dark" : ""}>
      <div className="min-h-screen font-sans relative bg-neutral-50 dark:bg-black text-neutral-900 dark:text-white transition-colors duration-300">
        ...
        <section
          ...
          style={{ backgroundImage: "url('/src/assets/hero-collage.jpg')" }}
        >
          ...
          <div className="relative z-10 text-center px-4 w-full max-w-5xl mx-auto mt-20">
            <h1 className="text-5xl md:text-7xl lg:text-[90px] font-black tracking-widest uppercase mb-6 text-white drop-shadow-2xl">
              Livestream Manila
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                ...
                className="w-full sm:w-auto bg-[#ff0000] hover:bg-red-700 text-white font-bold py-4 px-10 rounded-lg tracking-wider transition-colors shadow-lg shadow-red-600/30"
              >
                EXPLORE SERVICES
              </button>
              <button
                ...
                className="w-full sm:w-auto bg-white/10 backdrop-blur-sm border-2 border-white hover:bg-white/20 text-white font-bold py-4 px-10 rounded-lg tracking-wider transition-all"
              >
                CONTACT US
              </button>
            </div>
        ...
        <section
          id="about"
          className="py-24 border-t border-neutral-200 dark:border-neutral-900 transition-colors duration-300"
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-black tracking-wide uppercase mb-4 text-neutral-900 dark:text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20 items-stretch">
              <div className="flex flex-col justify-center">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold uppercase tracking-wider text-neutral-900 dark:text-white">
                    Our Story
                  </h3>
                </div>
                <div className="space-y-5 text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed">
                  <p>
                    ...
                    high-quality livestreaming services in the Philippines.
                  </p>
                  <p>
                    Today, we're proud to have delivered over 500 successful
                    events. Our commitment to technical excellence has made us
                    the go-to choice across Metro Manila.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-[#121212] p-8 md:p-10 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-xl relative overflow-hidden transition-colors duration-300">
                ...
                <h3 className="text-xl font-bold uppercase tracking-wider text-red-600 mb-8 relative z-10">
                  Our Mission
                </h3>
        ...
        <section
          id="promos"
          className="py-24 bg-white dark:bg-[#0a0a0a] border-t border-neutral-200 dark:border-neutral-900 transition-colors duration-300"
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-black tracking-widest uppercase text-neutral-900 dark:text-white">
                StreamSync Team
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
              {[
                {
                  name: "JOASH MARASIGAN",
                  role: "Project Lead",
                  exp: "System Architecture & UI/UX",
                },
                {
                  name: "CHARLES",
                  role: "Backend Developer",
                  exp: "Database Integration & Logic",
                },
                {
                  name: "GENETH",
                  role: "Systems Analyst",
                  exp: "Process Workflows",
                },
                {
                  name: "VICTOR",
                  role: "Database Administrator",
                  exp: "Data Security & Modeling",
                },
                {
                  name: "JULIE",
                  role: "Quality Assurance",
                  exp: "Testing & Validation",
                },
                {
                  name: "SHANEL",
                  role: "Documentation",
                  exp: "Technical Writing & QA",
                },
              ].map((member, i) => (
                <div
                  key={i}
                  className="bg-neutral-50 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-8 text-center hover:border-red-600/30 dark:hover:border-red-900/50 transition-colors shadow-sm dark:shadow-none"
                >
                  <div className="w-24 h-24 mx-auto rounded-full bg-neutral-200 dark:bg-neutral-800 mb-5 relative overflow-hidden">
                    <img
                      src={`https://ui-avatars.com/api/?name=${member.name.replace(" ", "+")}&background=7f1d1d&color=fff`}
                      alt={member.name}
            ...
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="text-4xl font-black tracking-wide mt-2 mb-4 text-neutral-900 dark:text-white">
                Current Promotions
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden group shadow-md dark:shadow-none transition-colors duration-300"
                >
                  <div className="h-48 bg-neutral-100 dark:bg-neutral-900 relative transition-colors duration-300">
                    ...
                    <div className="absolute top-4 right-4 z-20 bg-red-600 text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase">
                      Limited Time
                    </div>
                  </div>
                  <div className="p-8 pt-0 relative z-20">
                    ...
                    <div className="bg-neutral-50 dark:bg-black border border-neutral-200 dark:border-neutral-800 rounded-xl p-4 mb-6 mt-4 transition-colors duration-300">
                      ...
                      <p className="text-lg font-bold tracking-widest text-neutral-900 dark:text-white">
                        {promo.code}
                      </p>
                    </div>
                    <div className="flex items-center justify-between border-t border-neutral-200 dark:border-neutral-800 pt-5 transition-colors duration-300">
                      <span className="text-[11px] text-neutral-600 dark:text-neutral-500 flex items-center gap-1.5">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-8 hover:border-red-600/30 dark:hover:border-red-900/50 shadow-md dark:shadow-none transition-colors duration-300"
                >
                  <div className="w-12 h-12 bg-red-100 dark:bg-red-950/30 text-red-600 rounded-xl flex items-center justify-center mb-6">
                    <srv.icon size={24} />
                  </div>
                  <h3 className="text-lg font-bold tracking-wider mb-3 text-neutral-900 dark:text-white">
                    {srv.title}
                  </h3>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h3 className="text-xl font-bold uppercase tracking-widest text-center mb-10 text-neutral-900 dark:text-white">
              Rental Packages
            </h3>
              ...
              {[
                {
                  ...
                  desc: "Cameras, TriCaster system, monitors, communication sets.",
                },
                {
                  title: "Projector Package",
                  desc: "Epson projectors, screens, stands, laptop, and accessories.",
                },
                {
                  title: "Lights & Sounds Package",
                  desc: "QSC speakers, DM3 mixer, LED lighting rig, DJ setup.",
                },
              ].map((pkg, i) => (
                <div
                  key={i}
                  className="bg-neutral-50 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl flex flex-col hover:border-red-600/30 dark:hover:border-red-900/50 transition-colors shadow-sm dark:shadow-none"
                >
                  ...
                  <div className="p-8 relative z-20 flex flex-col items-center text-center flex-grow">
                    <h4 className="text-base font-bold tracking-widest mb-3 uppercase text-neutral-900 dark:text-white">
                      {pkg.title}
                    </h4>
                    <p className="text-xs text-neutral-600 dark:text-neutral-400 mb-8 leading-relaxed flex-grow">
                      {pkg.desc}
                    </p>
                    <button className="w-full bg-[#ff0000] hover:bg-red-700 text-white font-bold py-3 rounded-lg text-xs tracking-wider transition-colors">
                      VIEW SAMPLES
                    </button>
                  </div>
                </div>
              ...
              {[
                {
                  ...
                  type: "Conference",
                  loc: "SMX Convention Center",
                },
                {
                  title: "Corporate Meeting",
                  type: "Corporate",
                  loc: "Makati Shangri-La",
                },
                {
                ...
                >
                  <div className="h-48 relative bg-neutral-100 dark:bg-neutral-900 flex items-center justify-center transition-colors duration-300">
                    <span className="bg-black/60 dark:bg-black/50 px-3 py-1 rounded text-xs text-white">
                      {evt.type}
                    </span>
                  </div>
                  <div className="p-8">
                    <h4 className="text-sm font-bold uppercase text-neutral-900 dark:text-white">
                      {evt.title}
                    </h4>
                    <p className="text-[11px] text-neutral-600 dark:text-neutral-400 mt-2 flex items-center gap-2">
                      <MapPin size={12} className="text-red-600" /> {evt.loc}
                    </p>
                  </div>
                </div>
              ))}
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-3xl font-black tracking-wide uppercase mb-4 text-neutral-900 dark:text-white">
                Contact Us
              </h2>
              <div className="h-0.5 w-24 bg-red-600 mx-auto mt-6"></div>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              <div className="space-y-4">
                <div className="bg-neutral-50 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 flex items-start gap-4 transition-colors duration-300">
              ...
              <div className="lg:col-span-2 bg-neutral-50 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-2xl p-8 transition-colors duration-300">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="text-xl font-bold uppercase text-neutral-900 dark:text-white">
                    Send Us A Message
                  </h3>
                </div>
                <form className="space-y-4">
                  <input
                    ...
                    className="w-full bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800 rounded-xl px-4 py-3 text-sm text-neutral-900 dark:text-white focus:border-red-600 focus:outline-none transition-colors duration-300"
                  />
                  <textarea
                    rows="4"
                    placeholder="Tell us about your event..."
                    className="w-full bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800 rounded-xl px-4 py-3 text-sm text-neutral-900 dark:text-white focus:border-red-600 focus:outline-none transition-colors duration-300 resize-none"
                  ></textarea>
                  <button className="w-full bg-[#ff0000] hover:bg-red-700 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors">
